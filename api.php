...
function scrape_tgju() {
    ...
    $mapping = [
        ...
        // Gold
        'geram18'          => ['cat' => 'طلا', 'name' => 'طلای ۱۸ عیار', 'icon' => 'pics/geram18.svg'],
        'mesghal'          => ['cat' => 'طلا', 'name' => 'مثقال طلا', 'icon' => 'pics/mesghal.svg'],
        'ons'              => ['cat' => 'طلا', 'name' => 'اونس جهانی', 'icon' => 'pics/ons.svg'],
        'gold_futures'     => ['cat' => 'طلا', 'name' => 'طلای آبشده', 'icon' => 'pics/gold_futures.svg'],
        // Coin
        'retail_sekee'     => ['cat' => 'سکه', 'name' => 'سکه امامی', 'icon' => 'pics/retail_sekee.svg'],
        'sekeb'            => ['cat' => 'سکه', 'name' => 'سکه بهار آزادی', 'icon' => 'pics/sekeb.svg'],
        'retail_nim'       => ['cat' => 'سکه', 'name' => 'نیم سکه', 'icon' => 'pics/retail_nim.svg'],
        'retail_rob'       => ['cat' => 'سکه', 'name' => 'ربع سکه', 'icon' => 'pics/retail_rob.svg'],
        'retail_gerami'    => ['cat' => 'سکه', 'name' => 'گرمی', 'icon' => 'pics/retail_gerami.svg'],
        'coin_blubber'     => ['cat' => 'سکه', 'name' => 'حباب سکه', 'icon' => 'pics/coin_blubber.svg'],
        // Crypto
        'crypto-bitcoin'   => ['cat' => 'کریپتو', 'name' => 'بیتکوین', 'icon' => 'pics/crypto-bitcoin.svg'],
        'crypto-tether'    => ['cat' => 'کریپتو', 'name' => 'تتر', 'icon' => 'pics/crypto-tether.svg'],
        'crypto-ethereum'  => ['cat' => 'کریپتو', 'name' => 'اتریوم', 'icon' => 'pics/crypto-ethereum.svg'],
        'crypto-bnb'       => ['cat' => 'کریپتو', 'name' => 'بایننس کوین', 'icon' => 'pics/crypto-bnb.svg'],
        'crypto-solana'    => ['cat' => 'کریپتو', 'name' => 'سولانا', 'icon' => 'pics/crypto-solana.svg'],
        'crypto-ripple'    => ['cat' => 'کریپتو', 'name' => 'ریپل', 'icon' => 'pics/crypto-ripple.svg'],
        'crypto-dogecoin'  => ['cat' => 'کریپتو', 'name' => 'دوج کوین', 'icon' => 'pics/crypto-dogecoin.svg'],
        'crypto-tron'      => ['cat' => 'کریپتو', 'name' => 'ترون', 'icon' => 'pics/crypto-tron.svg'],
        'crypto-cardano'   => ['cat' => 'کریپتو', 'name' => 'کاردانو', 'icon' => 'pics/crypto-cardano.svg'],
        'crypto-litecoin'  => ['cat' => 'کریپتو', 'name' => 'لایت کوین', 'icon' => 'pics/crypto-litecoin.svg'],
        'crypto-bitcoin-cash' => ['cat' => 'کریپتو', 'name' => 'بیت‌کوین کش', 'icon' => 'pics/crypto-bitcoin-cash.svg'],
        'crypto-stellar'   => ['cat' => 'کریپتو', 'name' => 'استellar', 'icon' => 'pics/crypto-stellar.svg'],
        'crypto-polkadot'  => ['cat' => 'کریپتو', 'name' => 'پولکادات', 'icon' => 'pics/crypto-polkadot.svg'],
        'crypto-avalanche' => ['cat' => 'کریپتو', 'name' => 'آوالانچ', 'icon' => 'pics/crypto-avalanche.svg'],
        'crypto-dash'      => ['cat' => 'کریپتو', 'name' => 'دش', 'icon' => 'pics/crypto-dash.svg'],
        'crypto-shiba-inu' => ['cat' => 'کریپتو', 'name' => 'شیبا اینو', 'icon' => 'pics/crypto-shiba-inu.svg'],
        'crypto-toncoin'   => ['cat' => 'کریپتو', 'name' => 'تون‌کوین', 'icon' => 'pics/crypto-toncoin.svg'],
        'crypto-chainlink' => ['cat' => 'کریپتو', 'name' => 'چینلینک', 'icon' => 'pics/crypto-chainlink.svg'],
        'crypto-polygon'    => ['cat' => 'کریپتو', 'name' => 'پالیگان', 'icon' => 'pics/crypto-polygon.svg'],
        'crypto-uniswap'    => ['cat' => 'کریپتو', 'name' => 'یونی‌سوآپ', 'icon' => 'pics/crypto-uniswap.svg'],
    ];
